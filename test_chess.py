...
class TestPiece:
    ...
    def test_legal_moves(self):
        ...
        assert Pawn(Color.white, Square("h2")).legal_moves(lambda square: True) == {
            Square("g3"),  # TODO: No capturing logic yet
            Square("h3"),
        #   Square("i3"),  # out of bounds
            Square("h4"),
        }
        assert King(Color.white, Square("e1")).legal_moves(lambda square: True) == {
        ...
        assert Knight(Color.white, Square("g1")).legal_moves(lambda square: True) == {
            Square("h3"),
            Square("f3"),
            Square("e2"),  # TODO: No piece blocking yet
        #   Square("e0"),
        ...
        assert Rook(Color.white, Square("h1")).legal_moves(lambda square: True) == {
        ...
        assert Bishop(Color.white, Square("f1")).legal_moves(lambda square: True) == {
            Square("e2"),  # TODO: No piece blocking yet
        ...
        assert Queen(Color.white, Square("d1")).legal_moves(lambda square: True) == {
            Square("d2"),  # TODO: No piece blocking yet
            Square("d3"),  # TODO: No piece blocking yet
